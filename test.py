...
class Obstacle:
    ...
    def set_height(self):
        if (self.img_index == 0 or self.img_index == 1 or self.img_index == 2):
            ...
            height_index = random.randint(0,1)
...
def draw_window(win, dino, obstacles, base, score):
...
def main(): 
    ...
    while run:
        ...
        dino.move()
        base.move()
        draw_window(win, dino, obstacles, base, math.floor(score))
    pygame.quit()
    quit()
main()
